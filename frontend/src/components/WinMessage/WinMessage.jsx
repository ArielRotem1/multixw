...
export function WinMessage(props) {
            ...
            <>
                <Modal
                    ...
                    <Modal.Body className="d-flex flex-column justify-content-center align-items-center">
                        ...
                        {isLogin && <span id="got-coins-message">You got 10 coins!</span>}
    ...
    function handleCloseMultiplayer() {
        props.socket.emit("remove from game", props.gameID);
        setShowDialog(false);
    }
        ...
        <>
            <Modal
                ...
                <Modal.Body className="d-flex flex-column justify-content-center align-items-center">
                    ...
                    {!showPlayAgainBtn && <span style={{ fontSize: "2.6vmin", marginTop: "1vmin" }}>Waiting for other players{dots}</span>}
                </Modal.Body>
            </Modal>
        </>
    );
